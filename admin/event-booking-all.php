...
<!-- Mirrored from rn53themes.net/themes/demo/travelz/admin/event-booking-all.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Jan 2019 05:21:54 GMT -->
<head>
                            ...
                            <li><a href="javascript:void(0)" class="collapsible-header active"><i class="fa fa-ticket" aria-hidden="true"></i> Booking & Enquiry</a>
                                <div class="collapsible-body left-sub-menu">
                                    <ul>
                                        ...
                                        <li><a href="event-booking-all.html" class="menu-active">Events</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
