...
<!-- Mirrored from rn53themes.net/themes/demo/travelz/admin/user-add.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Jan 2019 05:21:52 GMT -->
<head>
                        ...
                        <li><a href="javascript:void(0)" class="collapsible-header active"><i class="fa fa-user" aria-hidden="true"></i> Users</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                                    ...
                                    <li><a href="user-add.html" class="menu-active">Add New user</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
