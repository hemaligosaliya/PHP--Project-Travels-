...
<!-- Mirrored from rn53themes.net/themes/demo/travelz/admin/ui-tab.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Jan 2019 05:21:54 GMT -->
<head>
                        ...
                        <li><a href="javascript:void(0)" class="collapsible-header active"><i class="fa fa-braille" aria-hidden="true"></i> Ui-Kits</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                                    ...
                                    <li><a href="ui-tab.html" class="menu-active">ui-tab</a>
                                    </li>
