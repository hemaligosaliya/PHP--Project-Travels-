        ...
        <div class="container-fluid">
            <div class="row topbot">
                <div class="col-md-3 profileleft animated fadeInLeft" id='side-left'>
                    <a class="userback animated fadeInLeft" href="../index.php"><i class="fa fa-home animated hinge infinite"></i> Back to Home page </a>
                            ...
                            <div class="row" style="padding-top: 20px;">
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="input-field col s10">
                                                <input id="list-title" type="radio" name="upgender" value="male" <?php if($row[7]=="male"){echo checked;} ?> class="with-gap">
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-field col s10">
                                            <input id="list-title" type="radio" name="upgender" value="female" <?php if($row[7]=="female"){echo checked;} ?> class="with-gap">
