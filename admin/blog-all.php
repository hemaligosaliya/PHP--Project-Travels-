...
<!-- Mirrored from rn53themes.net/themes/demo/travelz/admin/blog-all.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Jan 2019 05:21:54 GMT -->
<head>
                    ...
                    <ul class="collapsible" data-collapsible="accordion">
                        ...
                        <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-braille" aria-hidden="true"></i> Ui-Kits</a>
                            ...
                            <li><a href="javascript:void(0)" class="collapsible-header active"><i class="fa fa-rss" aria-hidden="true"></i> Blog & Articals</a>
                                <div class="collapsible-body left-sub-menu">
                                    <ul>
                                        <li><a href="blog-all.html" class="menu-active">All Blogs</a>
                                        </li>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Directory</td>
                                <td>24 may, 2017</td>
                                <td><a href="blog-edit.html" class="sb2-2-1-edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                </td>
...
<!-- Mirrored from rn53themes.net/themes/demo/travelz/admin/blog-all.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Jan 2019 05:21:55 GMT -->
</html>