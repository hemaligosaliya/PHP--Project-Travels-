...
<!-- Mirrored from rn53themes.net/themes/demo/travelz/admin/blog-add.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Jan 2019 05:21:55 GMT -->
<head>
                            ...
                            <li><a href="javascript:void(0)" class="collapsible-header active"><i class="fa fa-rss" aria-hidden="true"></i> Blog & Articals</a>
                                <div class="collapsible-body left-sub-menu">
                                    <ul>
                                        ...
                                        <li><a href="blog-add.html" class="menu-active">Add Blog</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
