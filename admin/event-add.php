...
<!-- Mirrored from rn53themes.net/themes/demo/travelz/admin/event-add.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Jan 2019 05:21:54 GMT -->
<head>
                        ...
                        <li><a href="javascript:void(0)" class="collapsible-header active"><i class="fa fa-calendar-o" aria-hidden="true"></i> Events</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                                    ...
                                    <li><a href="event-add.html" class="menu-active">Add New Event</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
